...
setTimeout(async function () {
  ...
  const house = new PublicKey("3LELSzDBRD9k1uBgHtEbtx33ZQUfkHRadHxu6JvUwawA")
...
console.log(abc + ": " + accounts[abc].toBase58())
  ...
  for (let i = 0; i < 100; i++) {
    await puppetMaster.rpc.pullStrings(new anchor.BN(10 ** 7), houseObj.houseBump, houseObj.operatorFeeAccountBump,  houseObj.authorFeeAccountBump,  houseObj.operatorTreasuryAccountBump,      {
      accounts: {
        author: houseObj.author,
        authorFeeAccount: houseObj.authorFeeAccount,
        operator: houseObj.operator,
